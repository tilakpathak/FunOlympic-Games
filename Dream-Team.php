...
<style>
    ...
    * {
    ...
    .content {
        background: url('https://img.olympicchannel.com/images/image/private/t_16-9_1240-700/f_auto/v1538355600/primary/ihlgxobnt29p5vgwarih')no-repeat;
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 style="color: #ffffff; font-size: 4rem; font-weight: 700;  line-height: 4rem; margin: 2.4rem 0px; text-transform: uppercase; width: auto;">
                Dream Team 1992 Revisited: Relive USA’s Basketball Olympic triumph at Barcelona ‘92
            </h1>
        </div>
        <div class="col-lg-12">
            <h2 style="color: #ffffff; font-size: 1.3rem; line-height: 2.3rem; margin-top: 2.4rem;">
                ...
                <br>
                For the first time in Olympic history, the United States team would feature active NBA stars Michael Jordan, Magic Johnson, and Charles Barkley.
                <br>
