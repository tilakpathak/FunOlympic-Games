...
<style>
    ...
    * {
    ...
    .content {
        background: url('https://img.olympicchannel.com/images/image/private/t_16-9_1240-700/f_auto/v1538355600/primary/xbjf99ixaqbealg6xgb5')no-repeat;
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 style="color: #ffffff; font-size: 4rem; font-weight: 700;  line-height: 4rem; margin: 2.4rem 0px; text-transform: uppercase; width: auto;">
                World Wrestling Championships 2022: Full Indian results at a glance
            </h1>
        </div>
        <div class="col-lg-12">
...
<br>
                Olympic medallists Bajrang Punia and Ravi Kumar Dahiya are chasing their first world titles as is three-time CWG gold-medallist Vinesh Phogat.
                <br>
                World championships silver-medallists Deepak Punia and Anshu Malik pulled out of the event after sustaining elbow injuries.
                <br>
                ...
                <br>
                World Wrestling Championships 2022: India results
                Greco-Roman<br>
                Arjun Halakurki (55kg)
                <br>
                Round of 16: Lost 5-3 vs Max Nowry (USA)
                <br>
                Vikas (72kg)
                <br>
                Qualifying: Lost 2-1 vs Shmagi Bolkvadze (GEO)
                <br>
                Sachin (77kg)
                <br>
                Round of 32: Lost 8-0 vs Aram Vardanyan (UZB)
                <br>
                Sunil Kumar (87kg)
                <br>
                Qualifying: Lost 1-1 (VPO1) to Ali Cengiz (TUR)
                <br>
                Neeraj (63kg)
                <br>
                Qualifying: Beat Samuel Lee Jones (USA) 4-0
                <br>
                Round of 16: Lost 9-0 to Luis Alberto Orta Sanchez (CUB)
                <br>
                Ashu (67kg)
                <br>
                Qualifying: Lost 9-0 to Mate Nemes (SRB)
                <br>
                Repechage: Lost 8-0 to Murat Firat (TUR)
                <br>
                Harpreet Singh (82kg)
                <br>
                Round of 16: Lost 3-1 to Yaroslav Filchakov (UKR)
                <br>
                Deepanshu (97kg)
                <br>
                Qualifying: Beat Seyeol Lee (KOR) 3-1
                <br>
                Round of 16: Lost 9-1 to Kiril Milov (BUL)
                <br>
                Repechage: Lost 12-0 to Nikoloz Kakhelashvili (ITA)
                <br>
                Gyanender (60kg)
                <br>
                Qualifying: Beat Leo Tudezca (FRA) 6-4
                <br>
                Round of 16: Lost 11-0 to Liguo Cao (CHN)
                <br>
                Satish (130kg)
                <br>
                Qualifying: Lost 10-1 to Sabah Saleh Shariati (AZE)
                <br>
                Women’s Wrestling<br>
                Sushma Shokeen (55kg)
                <br>
                Round of 16: Beat Yaynelis Sanz Verdecia (CUB) 2-1
                <br>
                Quarter-final: Lost 10-5 to Oleksandra Khomenets (UKR)
                <br>
                Repechage: Lost by fall to Mariana Dragutan (MDA)
                <br>
                Sonam Malik (62kg)
                <br>
                Qualifying: Beat Ayaulym Kassymova (KAZ) 8-0
                <br>
                Round of 16: Lost 7-2 to Ana Paula Godinez Gonzalez (CAN)
                <br>
                Neelam (50kg)
                <br><br>
